...
app.post('/livros', (req, res, next) => {
    ...
    let findLivro = livros.find(x => x.isbn == req.body.isbn);
    if(findLivro)
        res.status(400).json({message: 'ISBN Existente'});

    livros.push({id: contador += 1, titulo: livro.titulo, descricao: livro.descricao, edicao: livro.edicao, autor: livro.autor, isbn: livro.isbn});
...
app.put('/livros/:id', (req, res, next) => {
    ...
    livros[index] = {id: parseInt(id), titulo: req.body.titulo, descricao: req.body.descricao, edicao: req.body.edicao, autor: req.body.autor, isbn: req.body.isbn}
    res.status(200).json(livros);
})
